        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">IPO</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="#" className="w-8 h-8 bg-blue-700 rounded flex items-center justify-center">
          ...
          <div className="mt-8 flex justify-center">
            <div className="flex items-center">
              <span className="text-orange-600 font-bold text-xl">#startupindia</span>
            </div>
          </div>
          ...
          <div className="mt-8 text-xs text-gray-500 space-y-4">
            ...
            <p>
              The users can write to <a href="mailto:hello@bluestock.in" className="text-blue-600">hello@bluestock.in</a> for any app, website related queries. Also you can send IT / Tech related feedback to 
              <a href="mailto:cto@bluestock.in" className="text-blue-600 ml-1">cto@bluestock.in</a>
            </p>
            <p>
